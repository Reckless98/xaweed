...
export function LineCTA({
  ...
  if (variant === "banner") {
    return (
      <div
        className={`glass rounded-2xl p-8 text-center ${className ?? ""}`}
      >
        <div className="flex flex-col items-center gap-4">
          <div className="w-14 h-14 rounded-full bg-[#06C755]/20 flex items-center justify-center">
